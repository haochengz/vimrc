...
" turns out set background and colorscheme cannot been here, it has to
" be much lower at this file
" set background=dark
...
Plugin 'plasticboy/vim-markdown'                     " Markdown syntax for vim
...
" I change this to auto wrap the line because I was often run vim at laptops
" set nowrap
...
" I changed this to ignore cases for searching
set ignorecase
...
" I really like this one, but it seems not work, always calling paste
" The reason is cnoremap only mapping the key at command line code
cnoremap <C-A>      <Home>
cnoremap <C-B>      <Left>
cnoremap <C-E>      <End>
cnoremap <C-F>      <Right>
...
noremap <silent> ,hh :wincmd h<CR>
noremap <silent> ,jj :wincmd j<CR>
noremap <silent> ,kk :wincmd k<CR>
noremap <silent> ,ll :wincmd l<CR>
...
" I am writing scheme so I am sure need this to match parens
...
"-----------------------------------------------------------------------------
" Toggle the NERD Tree on an off with '-'
...
"-----------------------------------------------------------------------------
" VimSokoban settings maybe some kind of game, I don't like it
"-----------------------------------------------------------------------------
" Sokoban stuff
...
"-----------------------------------------------------------------------------
" EasyTags Set this directory as your home
"-----------------------------------------------------------------------------
let g:home_code_dir = '/home/hczhao/code'
